		...
		<view class="bs-bb p-0-30" v-show="isReach && isNone">
			...
			<view class="">
				<view class=" h-700 bg-fff">
					...
					<!-- 	<image src="../../static/icon/icon-04.png" class="w-200 h-200 " style="margin-top: 222rpx;"></image> -->
...
export default {
	...
	methods: {
		sendsearch(){
			...
			this.parameter.id = this.inputSearch;
			this.isReach = false
			this.isNone= false,
			this.getList();
		},
		...
		getList() {
			...
			this.$http.queryCouponProduct(this.parameter).then(res => {
